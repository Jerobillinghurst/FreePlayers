const products = [
...

  {
    id:3,
    name:"Cup Head",
    productType:"Aventura,Disparos,Cooperativo",
    price:975,
    rating:3.5,
    image:
          "https://wtfever.tv/wp-content/uploads/2020/05/cuphead.jpg",    
  
    description:" Cuphead y su hermano Mugman para luchar a través de varios niveles que culminan en peleas de jefes , con el fin de pagar su deuda con el Diablo ."  
  },
...

  {
    ...
    productType:"Adventura,Disparos,Violencia+18,Accion",
    price:1500,
    rating:5,
    image:
